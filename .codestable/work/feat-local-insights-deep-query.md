...
提交 `deep-query-coverage@3` clean checkpoint；用该提交的 release Engine 依次生成 25k、250k 与至少 30% 本机真实 Session byte sample 报告，原样打包进日期化 evidence 目录，接入根 verifier 后完成 Stage 5。
