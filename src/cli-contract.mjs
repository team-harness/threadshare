...
export const COMMAND_SPECS = Object.freeze({
  ...
  memory: command({
    ...
    output: [
      ...
      "stage: SkillCandidate is quarantined with evidence; CandidateDraftBatch returns an AdjudicationTask; AdjudicationResult quarantines retained candidates. review returns exact digests; prepare creates a CAS-bound plan; promote applies it.",
    ...
    agentNotes: [
      ...
      "After adjudication, use review digests verbatim in prepare, show the exact plan and lint findings, then promote only after the user's final confirmation.",
