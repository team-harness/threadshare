...
export const COMMAND_SPECS = Object.freeze({
  ...
  memory: command({
    ...
    arguments: [
      argument(
        "action",
        "<init|status|lint|extract|consolidate|review|promote|assemble|reverify-runner>",
    ...
    optionDetails: {
      ...
      "if-due": "Only for consolidate. Plan when at least 20 approved L1 entries are new or changed.",
      full: "Only for consolidate. Ignore the successful baseline and replay all approved L1 entries.",
    },
    defaults: [
      "--format text",
    ...
    examples: [
      ...
      "threadshare memory extract --runner codex --runner-model <model> --runner-endpoint <https-url> --request memory-filter.json",
