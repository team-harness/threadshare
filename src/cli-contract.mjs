...
export const COMMAND_SPECS = Object.freeze({
  ...
  insights: command({
    ...
    options: ["cursor", "format", "intent", "limit", "query", "regenerate-secret", "repository", "request", "revision", "stdio", "verify"],
    optionDetails: {
...
const INSIGHTS_ACTION_HELP = Object.freeze({
  ...
  sync: [
    ...
    "",
    "Usage:",
    "  threadshare insights sync [--repository <path> [--intent <repository-relative-markdown-file>]] [--format text|json]",
    "",
    "Behavior:",
