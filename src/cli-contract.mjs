...
export const COMMAND_SPECS = Object.freeze({
  ...
  insights: command({
    ...
    options: ["cursor", "format", "limit", "query", "regenerate-secret", "request", "revision"],
    optionDetails: {
    ...
    constraints: [
      ...
      "search requires exactly one of --query or --request; Usage and Activity require --request.",
